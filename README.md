...
在题库分类中选择 UWorld 和科目，即可开始练习；页面顶部会显示最近一次练习，可继续原位置或查看已完成结果。既有答题记录和旧版分组会话仍可读取。题目保留英文原文、原解析、图表和 PDF 页码；可在题目右上角点击“显示中文”，翻译题干、提问和全部选项；提交答案后，原书解析另有“显示中文 / 显示英文”切换。图表保留原图，其中嵌入的文字不自动翻译。原 PDF 可在教材中阅读，也可从解析打开对应页。
